package old.approved.test1279216111;
...
public class Main {
	...
	public static void run(net.egork.utils.old.io.old.InputReader in, PrintWriter out) {
		Solver solver = new InternetMediaTypes();
...
class MainChecker {
	public static String check(
		...
		return new InternetMediaTypesChecker().check(input, expectedOutput, actualOutput);
	}

	public static Collection<Test> generateTests() {
		return new InternetMediaTypesChecker().generateTests();
	}
}
