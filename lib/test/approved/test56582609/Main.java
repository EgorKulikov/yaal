...
public class Main {
	...
	public static void run(InputReader in, PrintWriter out) {
		Solver solver = new AngryChefCrispyChips();
...
class MainChecker {
	public static String check(InputReader input, InputReader expectedOutput, InputReader actualOutput) {
		return new AngryChefCrispyChipsChecker().check(input, expectedOutput, actualOutput);
	}

	public static Collection<Test> generateTests() {
		return new AngryChefCrispyChipsChecker().generateTests();
	}
}
