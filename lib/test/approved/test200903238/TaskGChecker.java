...
public class TaskGChecker extends Checker {
	@Override
	public String check(InputReader input, net.egork.utils.io.old.InputReader expectedOutput, InputReader actualOutput) {
