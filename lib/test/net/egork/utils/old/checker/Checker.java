package net.egork.utils.old.checker;
...
public abstract class Checker {
	public abstract String check(InputReader input, net.egork.utils.old.io.old.InputReader expectedOutput, InputReader actualOutput);
	...
	public String tokenCheck(
		net.egork.utils.old.io.old.InputReader expectedOutput, net.egork.utils.old.io.old.InputReader actualOutput) {
		int index = 0;
	...
	public String strictCheck(InputReader expectedOutput, net.egork.utils.old.io.old.InputReader actualOutput) {
		while (true) {
