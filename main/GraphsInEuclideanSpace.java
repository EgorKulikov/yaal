...
//		System.err.println(value);
	...
	private int[][] gravity(int[][] distances, int p) {
...
//					weight[j] += ratio * ratio;
					for (int k = 0; k < p; k++) {
						d[i][k] -= ratio * (result[j][k] - result[i][k]);
